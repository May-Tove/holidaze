    ...
    <main>
      ...
      <section className="w-3/4 flex flex-col-reverse lg:flex-row gap-12 items-center m-auto mb-32">
        ...
        <div className="w-full lg:w-3/5 flex flex-col gap-4">
          ...
          <p>
            ...
            home, you can list your property with us and start earning money. So
            why wait? Whether you’re looking to book your dream vacation or rent
            out your property to travelers worldwide, Holidaze has everything
      ...
      <section className="w-3/4 gap-4 flex flex-col m-auto mb-32">
        ...
        <p className="text-center mb-12 w-full lg:w-3/4 m-auto">
          From the white sandy beaches of the Caribbean to the bustling streets
          of Tokyo, we have a wide range of accommodations in some of the worlds
          most iconic and beautiful destinations.
        </p>
      ...
      <section className="w-3/4 flex flex-col lg:flex-row gap-12  items-center m-auto mb-32">
        <div className="w-full lg:w-3/5  flex flex-col gap-4">
          ...
          <p>
            ...
            world of possibilities for your next vacation. With an account, you
            can easily save your favorite accommodations, access exclusive
            deals, and receive personalized recommendations based on your travel
            preferences.
          </p>
          <p>
            Do you have a property that you would like to rent out to travelers
            worldwide? At Holidaze, we make it easy to connect with potential
            guests and maximize your earning potential.
          </p>
          <p>
            By listing your property on our website, you gain access to a global
            audience of travelers who are looking for unique and memorable
      ...
      <section className="w-3/4 flex flex-col-reverse lg:flex-row gap-12 items-center m-auto mb-12">
        ...
        <div className="w-full lg:w-3/5  flex flex-col gap-4">
          ...
          <p>
            If you’re a property owner looking to rent out your accommodations,
            our team can also help you maximize your earning potential and
            connect with a global audience of travelers. Contact us today to
