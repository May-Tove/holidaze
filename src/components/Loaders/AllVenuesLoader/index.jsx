...
const AllVenuesLoader = () => {
  return (
    <section className="py-10 w-full m-auto">
      <div className="grid grid-cols-3 gap-4">
        <div className="flex flex-col items-center bg-gray-100 rounded-2xl animate-pulse">
          <div className="h-72 w-full animate-pulse bg-gray-300 rounded-2xl" />
...
export default AllVenuesLoader;
